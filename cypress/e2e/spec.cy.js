...
describe('Final work', () => {
  context('Actions', () => {
    ...
    it('Automatic form', () => {
      ...
      BasePage.FirstName.type('Denis')
      BasePage.LastName.type('Nazarovs')

      //select male gender
      BasePage.GenderMale.click()
      ...
      //select subject
      BasePage.Subjects.type('Economics')
      ...
      //validate data
      SummaryPage.NameRow.should('have.text', 'Denis Nazarovs')
      SummaryPage.GenderRow.should('have.text', 'Male')
